...
// setCount=count-1; wrong way
 ...
 <div className="w-[100vw] h-[100vh] flex justify-center items-center bg-[#344151] flex-col gap-10">
  ...
  <div className="flex justify-center bg-white gap-12 py-3 rounded-sm text-[25px] text-[#344151]">
    ...
    <button onClick={increaseHandler} className="border-r-2 text-center w-20 border-[#bfbfbf] text-4xl">+</button>
  </div>
  <button onClick={resetHandler} className="bg-[#0398d4] text-white px-5 py-2
